...
<head>
    <title>Dishonored: Death of the Outsider - GameSatış</title>
        ...
        <nav>
            ...
            <ul>
                ...
                <div style="width: 500px;">
                    <form action="dishonored_death-of-the-outsider.php" method="GET" autocomplete="off">
                        <br>
...
?>
    ...
    <section class="hero3">
        ...
        <div class="signup-container5">
            ...
            <section>
                <h2>Hakkında</h2>
                <p>Dishonored: Death of the Outsider, Arkane Studios tarafından geliştirilen ve Bethesda
                    Softworks tarafından yayınlanan 2017 yapımı bir aksiyon-macera oyunudur. Dishonored 2'yi
                    takip eden bağımsız bir genişleme paketidir ve 15 Eylül 2017'de PlayStation 4, Windows ve
                    Xbox One için piyasaya sürülmüştür. Oyun, önceki başlıktaki olaylardan sonra sahil kenti
                    Karnaca'da geçiyor. Eski suikastçı Billie Lurk'ün (Rosario Dawson tarafından
                    seslendirilmiştir) akıl hocası Daud (Michael Madsen) ile The Outsider olarak bilinen
                    gizemli varlığı öldürmek için yeniden bir araya gelmesini konu alır. Oyun birinci şahıs
                    bakış açısından oynanır ve oyuncu görevleri gizlilikten amaca yönelik şiddetli çatışmaya
                    kadar çok çeşitli şekillerde tamamlamak için çeşitli doğaüstü yeteneklere erişebilir.</p>
...
$sql = "SELECT * FROM games WHERE name='Dishonored: Death of the Outsider'";
$result = mysqli_query($conn, $sql);

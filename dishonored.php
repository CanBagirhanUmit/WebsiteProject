...
<head>
    <title>Dishonored: Definitive Edition - GameSatış</title>
        ...
        <nav>
            ...
            <ul>
                ...
                <div style="width: 500px;">
                    <form action="dishonored.php" method="GET" autocomplete="off">
                        <br>
...
$sql = "SELECT * FROM games WHERE name='Dishonored - Definitive Edition'";
$result = mysqli_query($conn, $sql);

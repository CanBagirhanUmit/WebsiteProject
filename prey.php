        ...
        <nav>
            ...
            <ul>
                ...
                <div style="width: 500px;">
                    <form action="prey.php" method="GET" autocomplete="off">
                        <br>
    ...
    <section class="hero4">
        ...
        <div class="signup-container5">
            ...
            <section>
                <h2>Hakkında</h2>
                <p>
                    Prey, Arkane Austin tarafından geliştirilen ve Bethesda Softworks tarafından yayınlanan bir
                    birinci şahıs nişancı video oyunudur. PlayStation 4, Windows ve Xbox One için 5 Mayıs 2017
                    tarihinde dünya çapında piyasaya sürülmüştür.
                </p>
                <p>
                    Oyun, hızlandırılmış bir Uzay Yarışı'nın insanoğlunun yörünge istasyonlarına çok daha erken
                    gitmesine neden olduğu alternatif bir zaman çizelgesinde geçmektedir. Oyuncu, herhangi bir
                    cansız nesnenin klonuna dönüşmek gibi hem fiziksel hem de psişik güçlere sahip birçok
                    formdan oluşan düşmanca bir uzaylı gücü olan Typhon'u araştıran bilimsel bir ekibin parçası
                    oldukları Dünya-Ay L2 yörüngesindeki Talos I uzay istasyonunu keşfederken Morgan Yu'yu
                    kontrol ediyor. Typhon hapsedildiği yerden kaçarken, oyuncu istasyondan kaçmaya çalışırken
                    öldürülmekten kaçınmak için bazıları Typhon'un kendisinden türetilen çeşitli silahlar ve
                    yetenekler kullanır. Oyuncu, önemli eşyalar ve yetenekler edinerek istasyonun alanlarına
                    erişim kazanır ve sonunda oyuncunun istasyonu açık bir dünya ortamında keşfetmesine izin
                    verir. Oyun, tasarımında rol yapma video oyunları, gizlilik oyunları, sürükleyici simsler ve
                    Metroidvanias unsurlarını birleştiriyor.
                </p>
...
$sql = "SELECT * FROM games WHERE name='Prey'";
$result = mysqli_query($conn, $sql);

        ...
        <nav>
            ...
            <ul>
                ...
                <div style="width: 500px;">
                    <form action="doom.php" method="GET" autocomplete="off">
                        <br>
...
if(mysqli_num_rows($result) > 0) {    echo "<br><br>";
...
?>
    ...
    <section class="hero6">
        ...
        <div class="signup-container5">
            ...
            <section>
                <h2>Hakkında</h2>
                <p>Doom, id Software tarafından geliştirilen ve Bethesda Softworks tarafından yayınlanan 2016
                    yapımı bir birinci şahıs nişancı oyunudur. Oyuncular, Union Aerospace Corporation tarafından
                    Mars'taki enerji madenciliği tesislerinde serbest bırakılan cehennemden gelen şeytani
                    güçlerle savaşırken "Doom Slayer" olarak bilinen isimsiz bir uzay denizcisi rolünü
                    üstlenirler. Oyun, Doom 3'ün daha yavaş hayatta kalma korku yaklaşımından ilk iki oyuna daha
                    yakın, daha açık uçlu seviyelerle daha hızlı bir tempoya geri dönüyor. Ayrıca çevre geçişi,
                    karakter yükseltmeleri ve "zafer öldürmeleri" olarak bilinen infazları gerçekleştirme
                    yeteneği de içeriyor. </p>

                <p>
                    Doom eleştirmenler ve oyuncular tarafından iyi karşılandı. Tek oyunculu senaryo, grafikler,
                    müzikler ve oynanış önemli ölçüde övgü alırken, eleştirmenler oyunu klasik Doom oyunlarının
                    ve 1990'ların birinci şahıs nişancı oyunlarının ruhunu yeniden yakaladığı için takdir
                    ederken, çok oyunculu mod en önemli eleştirileri aldı. Piyasaya sürüldükten birkaç hafta
                    sonra Kuzey Amerika ve İngiltere'de en çok satan ikinci video oyunu oldu ve aynı süre içinde
                    PC'ler için 500.000'den fazla kopya sattı. Doom Eternal adlı bir devam oyunu Mart 2020'de
                    piyasaya sürüldü.</p>
...
$sql = "SELECT * FROM games WHERE name='Doom'";
$result = mysqli_query($conn, $sql);

...
<head>
    <title>Deathloop - GameSatış</title>
        ...
        <nav>
            ...
            <ul>
                ...
                <div style="width: 500px;">
                    <form action="deathloop.php" method="GET" autocomplete="off">
                        <br>
...
?>
    ...
    <section class="hero5">
        ...
        <div class="signup-container5">
            ...
            <section>
                <h2>Hakkında</h2>
                <p>Deathloop, Arkane Lyon tarafından geliştirilen ve Bethesda Softworks tarafından yayınlanan
                    bir birinci şahıs nişancı video oyunudur. Oyun 14 Eylül 2021'de PlayStation 5 ve Windows
                    için ve 20 Eylül 2022'de Xbox Series X/S için piyasaya sürüldü. Sanat tasarımını ve oynanışı
                    öven eleştirmenlerden genel olarak olumlu eleştiriler aldı. Deathloop, The Game Awards
                    2021'de En İyi Oyun Yönetimi ve En İyi Sanat Yönetimi ödüllerini kazandı.</p>
...
$sql = "SELECT * FROM games WHERE name='Deathloop'";
$result = mysqli_query($conn, $sql);
